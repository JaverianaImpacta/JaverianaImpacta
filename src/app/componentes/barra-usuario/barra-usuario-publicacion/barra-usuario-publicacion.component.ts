...
@Component({
  selector: 'app-barra-usuario-publicacion',
  standalone: true,
  imports: [],
  templateUrl: './barra-usuario-publicacion.component.html',
  styleUrl: './barra-usuario-publicacion.component.css'
})
export class BarraUsuarioPublicacionComponent {
  today: string;
