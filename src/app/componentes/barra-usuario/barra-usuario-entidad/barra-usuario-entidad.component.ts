...
@Component({
  selector: 'app-barra-usuario-entidad',
  standalone: true,
  imports: [],
  templateUrl: './barra-usuario-entidad.component.html',
  styleUrl: './barra-usuario-entidad.component.css'
})
export class BarraUsuarioEntidadComponent {
  today: string;
