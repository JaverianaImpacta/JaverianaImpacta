...
@Component({
  selector: 'app-barra-usuario-metricas',
  standalone: true,
  imports: [],
  templateUrl: './barra-usuario-metricas.component.html',
  styleUrl: './barra-usuario-metricas.component.css'
})
export class BarraUsuarioMetricasComponent {
  today: string;
