...
@Component({
  selector: 'app-barra-usuario-estudiante',
  standalone: true,
  imports: [],
  templateUrl: './barra-usuario-estudiante.component.html',
  styleUrl: './barra-usuario-estudiante.component.css'
})
export class BarraUsuarioEstudianteComponent {
  today: string;
