...
@Component({
  selector: 'app-barra-usuario-profesor',
  standalone: true,
  imports: [],
  templateUrl: './barra-usuario-profesor.component.html',
  styleUrl: './barra-usuario-profesor.component.css'
})
export class BarraUsuarioProfesorComponent {
  today: string;
