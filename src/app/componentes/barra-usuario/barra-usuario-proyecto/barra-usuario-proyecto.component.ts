...
@Component({
  selector: 'app-barra-usuario-proyecto',
  standalone: true,
  imports: [],
  templateUrl: './barra-usuario-proyecto.component.html',
  styleUrl: './barra-usuario-proyecto.component.css'
})
export class BarraUsuarioProyectoComponent {
  today: string;
