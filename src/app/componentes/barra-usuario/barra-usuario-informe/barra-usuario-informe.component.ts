...
@Component({
  selector: 'app-barra-usuario-informe',
  standalone: true,
  imports: [],
  templateUrl: './barra-usuario-informe.component.html',
  styleUrl: './barra-usuario-informe.component.css'
})
export class BarraUsuarioInformeComponent {
  today: string;
